...
class Small_LLM_Model:
    ...
    def decode(self, ids: torch.Tensor | list[int]) -> str | Any:
    ...
    def get_path_to_vocab_file(self) -> str | Any:
    ...
    def get_path_to_merges_file(self) -> str| Any:
    ...
    def get_path_to_tokenizer_file(self) -> str| Any:
